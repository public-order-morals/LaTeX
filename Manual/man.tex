...
\section{ログイン}
\label{sec:ログイン}
・ユーザ登録について言うのが大変そう\par
・ユーザ登録は管理者によって予め行われますとだけ言ってもいいかなと思った2156
...
\section{資産の登録}
\label{sec:資産の登録}
・各項目について入力形式とか詳しく言うかどうか\par
・Core2Duoは各項目ごとにsubsectionをたてることで「登録手順」としていた\par
